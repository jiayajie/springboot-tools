...
public class OrderServiceImpl implements OrderService {
    ...
    @Autowired
    private OrderItemRepostitory orderItemRepostitory;
     ...
     */
    @Override
    public ResultEntity pay(Long orderNo, Integer userId, String path) {
        Map<String, String> resultMap = new HashMap<>();

        //获取用户订单
        Order order = orderRepostitory.findByUserIdAndOrderNo(userId, orderNo);

        if (order == null) {
            return ResultUtil.error(404, "用户没有该订单");
        }
        ...
        //获取 用户下 订单 详情
        List<OrderItem> orderItemList = orderItemRepostitory.findByOrderNoAndUserId(orderNo, userId);
        ...
        AlipayTradePrecreateRequestBuilder builder = new AlipayTradePrecreateRequestBuilder()
                ...
                .setNotifyUrl("http://39.106.127.25:8010/callback")//支付宝服务器主动通知商户服务器里指定的页面http路径,根据需要设置
...
//                resultMap.put("qrUrl", qrUrl);
            ...
            case FAILED:
                ...
                return ResultUtil.error(400, "支付宝预下单失败");

            case UNKNOWN:
                logger.error("系统异常，预下单状态未知!!!");
                return ResultUtil.error(500, "系统异常，预下单状态未知!!!");
            default:
                logger.error("不支持的交易状态，交易返回异常!!!");
                return ResultUtil.error(500, "不支持的交易状态，交易返回异常!!!");
        }
    }
