...
import com.example.baseproject.modules.jpa.entity.WeiXinQRCode;
...
public class WxQrCode {
    ...
    public static String showQrcode(String ticket){
        ...
        params.put("ticket", WxResultUtil.urlEncode(ticket, WxResultUtil.DEFAULT_CHARSET));
        try {
            showqrcode_path = WxResultUtil.setParmas(params,showqrcode_path,"");
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public static WeiXinResult showQrcode(String ticket, String savePath) throws Exception{
        ...
        params.put("ticket", WxResultUtil.urlEncode(ticket, WxResultUtil.DEFAULT_CHARSET));
        WeiXinResult result = WxResultUtil.downMeaterMetod(params,WxResultUtil.GET_METHOD,showqrcode_path,savePath);
        return result;
    }
    ...
    public static String createTempTicket(String accessToken, String expireSeconds, int sceneId) {
        ...
        String datas = WxResultUtil.HttpsDefaultExecute(WxResultUtil.POST_METHOD,create_ticket_path,params,data);
        try {
            wxQRCode = new Gson().fromJson(datas, WeiXinQRCode.class);
        } catch (Exception e) {
            wxQRCode = null;
            e.printStackTrace();
        }
        return wxQRCode==null?null:wxQRCode.getAccess_token();
