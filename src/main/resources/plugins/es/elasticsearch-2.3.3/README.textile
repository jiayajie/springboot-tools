...
In order to play with the distributed nature of Elasticsearch, simply bring more notes up and shut down notes. The system will continue to serve requests (make sure you use the correct http port) with the latest data indexed.
